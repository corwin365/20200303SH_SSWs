...
DaysPerRun = 3;
Days = datenum(2003,1,1):DaysPerRun:datenum(2003,1,365);
[~,m,~] = datevec(Days);
Days(m <  5 | m > 11) = []; 
clear m
...
for iDay=1:1:numel(Days);
  ...
  Text5 = ['\nmatlab -nodisplay -r "cd /home/f/cw785/Matlab/20200227ManfredComparison;maxNumCompThreads(',num2str(NThreads),');'];
  Commands = ['Settings.DayScale=',num2str(Days(iDay)),'+(0:1:',num2str(DaysPerRun-1),');airs_gws'];
