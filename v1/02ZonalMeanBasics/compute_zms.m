...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%generate zonal mean time series of basic variables
%
  ...
  try
    ...
    switch VarInfo{1}
      case 'ECMWF';
        ...
        %average down to lat range and take daily zonal mean
        InLatRange = inrange(Data.ECMWF.latitude,Settings.LatRange);
        VarData = squeeze(nanmean(nanmean(nanmean(VarData(:,InLatRange,:,:),2),1),4));

        %interpolate onto output height grid and store
        Results.Data(iVar,iDay,:) = interp1(Data.ECMWF.Z,VarData,Settings.HeightScale);
        
        %tidy up
        clear VarData InLatRange yy dn 
